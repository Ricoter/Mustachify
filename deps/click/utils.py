...
from ._compat import (PY2, WIN, _default_text_stderr, _default_text_stdout,
                      auto_wrap_for_ansi, binary_streams, filename_to_ui,
                      get_filesystem_encoding, get_streerror, is_bytes,
                      open_stream, should_strip_ansi, string_types, strip_ansi,
                      text_streams, text_type)
from .globals import resolve_color_default

if not PY2:
    from ._compat import _find_binary_writer
elif WIN:
    from ._winconsole import (_get_windows_argv, _hash_py_argv,
                              _initial_argv_hash)
